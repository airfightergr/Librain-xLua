...
--tabletShow					= find_dataref("avanti/avionics/tablet/showTablet")
...
function flight_start()
	...
	local mask0_obj                  = mask_path .. "cockpit_panel.obj"
...
--	local mask6_obj                  = "Aircraft/MyPlanes/P180_Avanti_GitHub/P180_Avanti_II/avanti_cockpit.obj"
	...
	backGlass_tp_x = 0.0
	backGlass_tp_y = 0.0
	backGlass_thrust_factor = 0.0
	backGlass_max_thrust = 1800
	backGlass_gp_x = 0.5
	backGlass_gp_y = 2.0
